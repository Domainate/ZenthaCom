    ...
    function processChartData(data) {
        ...
        ['Digestion', 'Environment', 'Awareness', 'Perspective'].forEach(variable => {
            if (data.Variables[variable] == 'right') {
                document.querySelector(`#variable-${variable.toLowerCase()}`).classList.remove('wb-left');
                document.querySelector(`#variable-${variable.toLowerCase()}`).classList.add('wb-right');
            }
        });
